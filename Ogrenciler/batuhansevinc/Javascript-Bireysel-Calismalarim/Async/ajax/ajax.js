...
request.addEventListener('load',funcRequest);

function funcRequest(){
    // const data = request.responseText;
    // console.log(data);
    // console.log(typeof data);
    // gelen bilgi string olduğu için bunu json'a çevirmem lazım 
...
function setCountry(data){
    ...
    <div class="col-3">
        <div class="card h-100">
            ...
            <li class="list-group-item">Population: ${(data.population / 1000000).toFixed(1)} Millions</li>
