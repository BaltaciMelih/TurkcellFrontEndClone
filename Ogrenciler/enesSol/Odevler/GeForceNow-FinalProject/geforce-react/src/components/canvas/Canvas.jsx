...
import "./Canvas.scss";
import CategoryArrow from "../../assets/games/icons-arrow-large.png";
...
const Canvas = () => {
  return (
    <>
      <button
        className="btn btn-dark d-block d-md-none filter-btn w-50 me-3 d-flex justify-content-between"
        type="button"
      ...
      >
        ...
        <div className="offcanvas-body">
          <div className="filter-wrapper d-flex justify-content-between">
            <h3
              className="filter-main-tilte fs-1"
            ...
            <img
              src={CategoryArrow}
              width={40}
              className="category-arrow text-white"
              data-bs-toggle="collapse"
              href="#collapseExample"
              role="button"
              aria-expanded="false"
          ...
          <div className="collapse show" id="collapseExample">
            <div className="card filter-games-wrapper category-card card-body text-darkgray">
