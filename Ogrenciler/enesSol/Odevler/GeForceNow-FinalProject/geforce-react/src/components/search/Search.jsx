  ...
  return (
    <>
      <div className="games-page">
        <div className="container-fluid gamespage-banner w-100">
        ...
        <div className="games-container container-fluid d-flex justify-content-center justify-content-md-between my-0 mx-5 p-0 p-md-5 text-white">
