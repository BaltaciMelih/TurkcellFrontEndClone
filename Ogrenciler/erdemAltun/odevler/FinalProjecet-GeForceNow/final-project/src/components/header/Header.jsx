      ...
      <nav className="navbar navbar-expand-lg bg-light px-lg-5 px-0">
        <div className="container-fluid">
          <Link to="/" className="navbar-brand">
            <img src={Logo} className="game-plus mx-sm-0" alt="logo" />
          </Link>
          ...
          <div className="collapse navbar-collapse" id="navbarText">
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 mx-auto">
              <li className="nav-item px-xl-3 px-lg-0">
                <Link to="/games" className="nav-link text-black fw-bold" href="#">
                  Games
                </Link>
              </li>
            ...
            <button
              type="button"
              className="btn btn-green fw-bold text-center text-white"
            >
              LET'S PLAY
            </button>
          </div>
