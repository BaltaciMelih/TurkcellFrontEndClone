  ...
  return (
    <>
      ...
      <div className="position-relative d-none d-md-flex justify-content-center">
        <div className="container features-title px-5 py-3 ">
      ...
      {/* Container-Free */}
      <div className="container-empty d-none d-md-flex"></div>

      {/* Container Screen */}
      <div className="container-devices text-center justify-content-around ">
        <span className="devices-info text-center">
          On all your screens at home and on the go
        </span>
        <div className="row d-flex justify-content-center">
          <div
            className="col-md-4 col-sm-12 d-flex align-items-center text-center justify-content-center p-4 text-white border border-dark mt-5 mb-5 me-5 ms-5 devices"
            role="button"
          >
          ...
          <div
            className="col-md-4 col-sm-12 d-flex align-items-center text-center justify-content-center p-4 text-white border border-dark mt-5 mb-5 me-5 ms-5 mx-lg-5 devices"
            role="button"
          >
            <div className="d-flex text-center align-items-center justify-content-center">
              <img
      ...
      <div className="container text-center">
        <div className="row justify-content-center">
          <span className="gamepic-info text-center">
            Choose the game you want to play
          </span>
          <div className="picgames col-lg-2 mt-5  ">
        ...
        <div className="row justify-content-center part2">
          <div className="picgames col-lg-2">
          ...
          <div className="membership-card">
            <div className="member-card">
              ...
              <div className="mem-details">
                <span className="rights notselected">Standart Access</span>
                <span className="rights notselected">
                  1-hr session length
                </span>
                <span className="rights notselected text-secondary">
                  Standart Access
                </span>
                <span className="rights notselected">
                  1-hr session length
                </span>
                <button type="button" className="btn  btn-block green-btn">
                  JOIN NOW
                </button>
              </div>
            </div>
            ...
            <div className="member-card active-card">
              ...
              <span className="mem-price">15$/month</span>
              <div className="mem-details">
                <span className="rights selected">Standart Access</span>
                <span className="rights selected">1-hr session length</span>
                <span className="rights selected">Standart Access</span>
                <span className="rights selected">1-hr session length</span>
                <button type="button" className="btn  btn-block green-btn">
                  JOIN NOW
            ...
            <div className="member-card">
              ...
              <span className="mem-price">30$/month</span>
              <div className="mem-details">
                <span className="rights notselected">Standart Access</span>
                <span className="rights notselected">
                  1-hr session length
            ...
            <div className="container-fluid  text-center mt-5 p-sm-5  dark-grey d-flex gamepad-container">
              ...
              <div className="row gamepad-shadow  ">
                ...
                <div className="col-lg-8 text-start p-4 pt-0 pt-sm-4 mt-4">
                  <p className="date">GAMING - AUGUST 11, 2020</p>
                  <p className="gamepad-lorem">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Phasellus curvus orci et!
                  </p>
                  <p className="gamepad-lorem-text">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
      ...
      {/* Logitech */}
      <div className="container-fluid partner-info w-100">
        <h3 className="text-white text-center pt-5">
          Lorem ipsum dolor sit amet consectetur adipiscing
        </h3>
        <div className="logitech d-flex justify-content-center align-items-center gap-5 flex-wrap overflow-hidden">
          <div className="d-flex justify-content-center align-items-center gap-5 flex-wrap overflow-hidden">
            <div className="hexagone text-center">
              <img src={Logitech1} alt="" className="Logolar1 mt-4" />
            </div>
            <div className="hexagone text-center">
              <img src={Logitech2} alt="" className="Logolar2" />
            </div>
            <div className="hexagone text-center d-none d-sm-block">
              <img src={Logitech1} alt="" className="Logolar1 mt-4" />
            </div>
            <div className="hexagone text-center d-none d-sm-block">
              <img src={Logitech2} alt="" className="Logolar2" />
