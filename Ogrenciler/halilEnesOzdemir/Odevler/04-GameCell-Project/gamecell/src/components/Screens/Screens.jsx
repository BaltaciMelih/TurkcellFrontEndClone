  ...
  return (
    <>
      <div className='container-fluid screen-bg text-white text-center '>
        <h1 className='fs-3 py-2 px-sm-4'>On all your screens at home and on the go</h1>
        <div className=' container-sm mx-auto row row-cols-1 row-cols-lg-3 d-flex flex-lg-row flex-wrap flex-lg-nowrap  px-2 py-3 gap-3 gap-lg-3 screens  px-1 px-sm-3 py-lg-5 px-lg-5'>
          <div className=' py-2  py-lg-4  screen-border d-flex justify-content-start justify-content-lg-center align-items-center gap-2  '>
            <img
          ...
          <div className='  py-2 py-lg-3  screen-border d-flex justify-content-start justify-content-lg-center  align-items-center gap-2  '>
            <img
