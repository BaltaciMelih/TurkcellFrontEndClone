    ...
    <>
      ...
      >
        <div className="carousel-indicators">
          <button
            type="button"
            data-bs-target="#carouselDarkGames"
            data-bs-slide-to="0"
            className="active"
            aria-current="true"
            aria-label="Slide 1"
      ...
      <div className="position-relative d-none d-md-flex justify-content-center">
        <div className="container features px-5 py-3 ">
      ...
      <div className="container-free d-none d-md-flex"></div>

      <div className="container-screen-plus text-center justify-content-around ">
        <span className="header-devices text-center">
          On all your screens at home and on the go
        </span>
        <div className="row d-flex justify-content-center">
          <div
            className="col-md-4 col-sm-12 d-flex align-items-center text-center justify-content-center p-4 text-white border border-dark mt-5 mb-5 me-5 ms-5 devices-card"
            role="button"
          >
          ...
          <div
            className="col-md-4 col-sm-12 d-flex align-items-center text-center justify-content-center p-4 text-white border border-dark mt-5 mb-5 me-5 ms-5 mx-lg-5 devices-card"
            role="button"
          >
            <div className="d-flex text-center align-items-center justify-content-center">
              <img
      ...
      <div className="container text-center">
        <div className="row justify-content-center">
          <span className="gamepic-header text-center">
            Choose the game you want to play
          </span>
          <div className="imagegames col-lg-2 mt-5  ">
        ...
        <div className="row justify-content-center games-part2">
          <div className="imagegames col-lg-2">
        ...
        <div>
          ...
          <div className="membership-content">
            <div className="member-card">
              ...
              <span className="member-price">Free</span>
              <div className="member-details">
                ...
                <button type="button" className="btn  btn-block buy-btn">
                  JOIN NOW
                </button>
              </div>
            </div>
            ...
            <div className="member-card active-card">
              ...
              <span className="member-price">15$/month</span>
              <div className="member-details">
            ...
            <div className="member-card">
              ...
              <span className="member-price">30$/month</span>
              <div className="member-details">
                <span className="benefits notselected">Standart Access</span>
                <span className="benefits notselected">
                  1-hr session length
      ...
      >
        ...
        <button
          className="carousel-control-prev"
          type="button"
          data-bs-target="#carouselControlsGamepad"
          data-bs-slide="prev"
        >
      ...
      <div className="container-fluid partner-banner w-100">
        <h3 className="text-white text-center pt-5">
          Lorem ipsum dolor sit amet consectetur adipiscing
        </h3>
        <div className="partnerships d-flex justify-content-center align-items-center gap-5 flex-wrap overflow-hidden">
